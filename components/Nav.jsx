  ...
  return (
    <nav className="bg-transparent sticky top-0 z-10 navbar-fixed bg-slate-100 flex justify-between w-full mb-16 py-3 px-10 items-center">
      ...
      <div className=" justify-between gap-5 sm:flex hidden mr-20 ">
        <Link href={"/about"} className="text-lg  text-black hover:text-secondary">
          About Us
        </Link>
        <Link href={"/products"} className="text-lg  text-black hover:text-secondary">
          Product
        </Link>
        <Link href={"/contact"} className="text-lg  text-black hover:text-secondary">
          Contact
        </Link>
      </div>
